...
namespace AllPrograms
{
    public class AllPrograms
    {
        public void RunAllPrograms()
        {
			...
			//Console.WriteLine(largeNumber);  // Output: 100


			//explicit (narrowing) conversions :you must use a cast (()) because data may be lost.


			//double dbl = 1234567890123456789d;
			//float f = (float)dbl;
			//Console.WriteLine(f);
			//
			//similary float to long, long to int, int to char


			//string to int
			//1. Explicit conversion using Parse()
			//string str = "100";
			//int number = int.Parse(str);
			//Console.WriteLine(number); // Output: 100

			//2.Explicit conversion using Convert.ToInt32()
			//string str1 = "100";
			//int number1 = Convert.ToInt32(str1);
			//Console.WriteLine(number1); // Output: 100
